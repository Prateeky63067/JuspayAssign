...
const ActionArea = ({ add_list }) => {
  ...
  return (
    <div className={`flex-1 h-[90vh] overflow-y-auto  p-2 `}>
      <div className="flex flex-wrap gap-4 items-center mb-[2.25rem] justify-center">
        <h1
          className={`font-poppins text-[1.1rem] font-semibold cursor-pointer ${
            activeView === "midarea" && "bg-red-600 p-2 rounded-md text-white"
          }`}
          onClick={() => {
        ...
        <h1
          className={`font-poppins text-[1.1rem] font-semibold cursor-pointer flex items-center gap-3 ${
            ...
            "bg-red-600 p-2 rounded-md text-white"
          }`}
          onClick={() => {
